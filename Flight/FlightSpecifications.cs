...
namespace FlightTest
{
    public class FlightSpecifications
    {
        ...
        public void Doesnt_cancel_bookings_for_passengers_who_have_not_booked()
        {
            ...
            var error = flight.CancelBooking(passengerEmail: "A@bb.com", numberOfSeats: 2);
        ...
        {
            var flight = new Flight(3);
            flight.Book(passengerEmail: "A@bb.com", numberOfSeats: 1);
            var error = flight.CancelBooking(passengerEmail: "A@bb.com", numberOfSeats: 1);
            error.Should().BeNull();
        }
    }
}
